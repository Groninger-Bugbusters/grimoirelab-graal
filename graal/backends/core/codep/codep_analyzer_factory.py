...
from graal.backends.core.codep.compositions.composition_reverse import *


class CoDepAnalyzerFactory:
    """Factory class for Analyzer Compositions"""

    version = '0.1.0'

    def __init__(self, jadolint_exec_path=None):
    ...
    def __load_compositions(self):
        ...
        self.compositions = {}
        self.__add(CompositionJadolintDependencies(jadolint_exec_path=self.jadolint_exec_path))
        self.__add(CompositionReverse())
